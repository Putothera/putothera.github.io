...
// --- Your Customized Card Data ---
const cardData: BentoCardProps[] = [
    {
      color: "#060010",
      title: "Security & Compliance",
      description: "ISO 27001/27701 audits and security best practices.",
      label: "Secure",
      imageUrl: "https://placehold.co/600x400/060010/a855f7.png?text=Secure",
    },
    {
      color: "#060010",
      title: "Custom API & Integrations",
      description: "Connecting systems like Salesforce and Slack.",
      label: "Integrate",
      imageUrl: "https://placehold.co/600x400/060010/a855f7.png?text=Integrate",
    },
    {
      color: "#060010",
      title: "Workflow Automation",
      description: "Designing automations that eliminate manual tasks.",
      label: "Automate",
      imageUrl: "https://placehold.co/600x400/060010/a855f7.png?text=Automate",
    },
    {
      color: "#060010",
      title: "Internal Tool Development",
      description: "Building custom apps and scripts for team success.",
      label: "Develop",
      imageUrl: "https://placehold.co/600x400/060010/a855f7.png?text=Develop",
    },
    {
      color: "#060010",
      title: "Jira & Atlassian Suite",
      description: "Complex Jira workflows and automations.",
      label: "Organize",
      imageUrl: "https://placehold.co/600x400/060010/a855f7.png?text=Organize",
    },
    {
      color: "#060010",
      title: "AI Agent Development",
      description: "Building AI agents from scratch using n8n.",
      label: "Innovate",
      imageUrl: "https://placehold.co/600x400/060010/a855f7.png?text=Innovate",
    },
];
  ...
  enableTilt?: boolean; clickEffect?: boolean; enableMagnetism?: boolean;
    ...
    const clearAllParticles = useCallback(() => {
        ...
        particlesRef.current.forEach((particle) => {
            gsap.to(particle, { scale: 0, opacity: 0, duration: 0.3, ease: "back.in(1.7)",
    ...
    const animateParticles = useCallback(() => {
        ...
        memoizedParticles.current.forEach((particle, index) => {
            const timeoutId = setTimeout(() => {
                ...
                gsap.to(clone, { x: (Math.random() - 0.5) * 100, y: (Math.random() - 0.5) * 100,
...
const GlobalSpotlight: React.FC<{ gridRef: React.RefObject<HTMLDivElement | null>; disableAnimations?: boolean; enabled?: boolean;
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  enableTilt = true, glowColor = DEFAULT_GLOW_COLOR, clickEffect = true, enableMagnetism = true,
}) => {
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%); --purple-primary: rgba(132, 0, 255, 1);
            --purple-glow: rgba(132, 0, 255, 0.2); --purple-border: rgba(132, 0, 255, 0.8);
          }
          .card-responsive { display: grid; grid-template-columns: 1fr; width: 100%; margin: 0 auto; padding: 0.5rem; }
          ...
          .card--border-glow::after {
            ...
            pointer-events: none;
            /* The glow is now controlled by --glow-intensity, not opacity or hover */
            z-index: 1;
          }
          
          /* This :hover rule is no longer needed */
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            ...
            const cardStyle = { borderColor: "var(--border-color)", color: "var(--white)" } as React.CSSProperties;
            const cardContent = (
              <>
                {card.imageUrl && (
                  <>
                    <Image src={card.imageUrl} alt={card.title || "Card background"} fill className="absolute inset-0 object-cover z-0"/>
